...
namespace HK2\CspWhitelisting\Block\Adminhtml\System\Config;
...
class ResetButton extends Field
{
     ...
     * @var string
     */
    protected $_template = 'HK2_CspWhitelisting::system/config/reset_button.phtml';
...
//    }
    ...
    {
        return $this->getUrl('cspwhitelisting/reset/resetconfig');
    }
